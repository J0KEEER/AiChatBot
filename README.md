...
[![Build & Tests](https://img.shields.io/badge/Tests-33%20Passed%20%28100%25%29-brightgreen.svg?logo=checkmarx&logoColor=white)](#-automated-testing)
...
An intelligent, rule-based **AI Virtual Assistant** built in Java featuring natural language text preprocessing, Levenshtein distance typo tolerance, chat slang normalization, compound query resolution, real-time live weather integration, and dynamic date/time tracking. 
...
### 🧠 1. NLP Text Preprocessing & Typo Correction
...
### 🌤️ 2. Dynamic Real-Time Information Synthesis
...
- **Conjunction Intent Splitting:** Splits multi-clause inquiries connected by `and`, `also`, `plus`, or commas (e.g., *"what are your hours and who made you"*) and returns responses for all matched intents.

### 💻 4. Modern Swing GUI & Terminal CLI
- **Rich Swing GUI:** 
...
### 📂 5. Extensible Knowledge Base (Hot-Loadable)
...
└── src/                    # Java source code
    ...
    ├── ChatEngineTest.java # Automated test suite (33 headless unit & integration tests)
...
- **Network Connection:** Required only for real-time live weather lookups; all other NLP and intent features operate completely offline.
...
The chatbot intelligently routes queries across conversational, dynamic, and external categories:
...
| **Slang Identity** | *"hu r u"* | Expands to *"who are you"*, explains chatbot role. |
...
| **Compound FAQ Query** | *"what are your hours and who made you"* | Answers both working hours and creator in a single multi-part response. |
...
- **Field 1 (`tag`):** Unique identifier for the intent (e.g., `pricing`, `refund`).
...
### Test Coverage Highlights (33 Assertions):
...
- ✅ **Compound Multi-Intent & Multi-Dynamic Inquiries:** Tests multi-part queries involving weather, date, time, and FAQs.
